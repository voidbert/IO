...
A solução dada pelo RELAX4 na secção anterior contem informação sobre o fluxo máximo e sobre o fluxo
em cada arco. Da primeira linha do \emph{output}, \texttt{s -70}, pode concluir-se que o fluxo
...
De seguida, apesar da solução do RELAX4 conter o valor do fluxo em cada arco, estes arcos são os do
grafo transformado e não os do grafo original. Para se obterem valores relativos ao grafo original,
será necessário desfazer, passo a passo, a transformação feita anteriormente, tendo em conta o fluxo
em cada arco. Em primeiro lugar, apresenta-se o grafo descrito pela solução do RELAX4, onde a cada
...
\begin{figure}[H]
    ...
    \caption{Grafo descrito pelo \emph{output} do RELAX4.}
