...
\begin{enumerate}[\hspace{1cm} \bfseries 1.]
    ...
    \item Gerar restrições relativas ao número máximo de contentores de cada capacidade: o número
        ...
        % TODO - Mudar script para usar estas variáveis auxiliares, se o professor aprovar isto
...
problemas maiores e em contextos em que os dados estão em constante mudança, e evitando o
desperdício de horas humanas em cálculos que facilmente podem ser executados por um computador.
