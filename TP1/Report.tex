...
\begin{figure}[H]
    ...
    \caption{Duas possíveis interpretações para o mesmo conjunto de variáveis de decisão,
...
2 aspetos importantes do modelo. Primeiramente, é exigido que, no fim da aplicação dos
